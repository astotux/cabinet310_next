...
export const metadata: Metadata = {
  ...
  keywords: ["салон красоты сыктывкар", "перманентный макияж сыктывкар", "пудровые брови сыктывкар", "татуаж губ сыктывкар", "межресничка сыктывкар", "маникюр сыктывкар", "ламинирование ресниц сыктывкар", "студия красоты сыктывкар", "перманент бровей"],

...
export const metadata: Metadata = {
  ...
  title: {
    default: "Кабинет 310 — Салон красоты в Сыктывкаре | Перманентный макияж и маникюр",
  ...
  openGraph: {
    ...
    title: 'Кабинет 310 — Салон красоты в Сыктывкаре',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Кабинет 310 — Салон красоты в Сыктывкаре',
      },
    ],
  },
  twitter: {
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "BeautySalon",
              "name": "Кабинет 310",
              "description": "Салон красоты в Сыктывкаре. Перманентный макияж бровей, губ и межреснички, маникюр, ламинирование ресниц.",
              "url": "https://cabinet310.ru",

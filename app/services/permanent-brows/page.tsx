...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Перманентный макияж бровей — Кабинет 310 в Сыктывкаре",
    description: "Естественные и красивые брови на годы. Пудровая техника, волосковый метод, коррекция формы. Записывайтесь к лучшим мастерам Сыктывкара.",
    images: ['/og-permanent-brows.jpg'],
    type: 'website',
    locale: 'ru_RU',
    url: 'https://cabinet310.ru/services/permanent-brows',
    siteName: 'Кабинет 310',
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Перманентный макияж бровей — Кабинет 310 в Сыктывкаре',
    description: 'Естественные и красивые брови на годы. Пудровая техника, волосковый метод, коррекция формы.',
    images: ['/og-permanent-brows.jpg'],
  },
  alternates: {
    canonical: 'https://cabinet310.ru/services/permanent-brows',
  },
  other: {
...
export default function PermanentBrowsPage() {
  const techniques = [
    {
      name: "Пудровые брови",
      description: "Мягкая растушевка, создающая эффект подкрашенных тенями бровей",
      icon: "brush",
      duration: "2-3 часа",
      healing: "7-14 дней",
      result: "1-2 года"
  ...
  const faqItems = [
    {
      question: "Больно ли делать перманентный макияж бровей?",
      answer: "Мы используем качественную анестезию, поэтому процедура проходит комфортно. Большинство клиентов отмечают лишь легкий дискомфорт.",
      icon: "healing"
    },
    {
      question: "Сколько держится перманентный макияж бровей?",
      answer: "В зависимости от техники и индивидуальных особенностей кожи — от 1 до 2 лет. Пудровые брови держатся дольше волосковой техники.",
      icon: "schedule"
    },
    {
      question: "Нужна ли коррекция после процедуры?",
      answer: "Да, коррекция проводится через 4-6 недель после первой процедуры. Она необходима для идеального результата.",
      icon: "tune"
    },
    {
      ...
      <main className="max-w-7xl mx-auto px-6 md:px-8 lg:px-6 max-[480px]:px-4 max-[320px]:px-3 py-12 md:py-16 max-[480px]:py-8 max-[320px]:py-6 max-[767px]:pb-32 overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center w-full">
            <div className="space-y-6 md:space-y-8 max-[480px]:space-y-5 relative z-10">
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black leading-[0.95] tracking-tight">
                Идеальные <span className="text-gradient">брови</span> на годы
              </h1>
          ...
          <div className="relative rounded-2xl md:rounded-[3rem] overflow-hidden bg-gradient-to-br from-slate-50 to-slate-100 p-8 md:p-12 lg:p-16 max-[480px]:p-6">
            ...
            <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-12 items-center">
              <div className="space-y-6 md:space-y-8">
                ...
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-black">Пудровые брови</h2>
                <p className="text-lg md:text-xl text-slate-600 leading-relaxed">
                  Мягкая растушевка, создающая эффект подкрашенных тенями бровей. Подходит для всех типов кожи и обеспечивает естественный результат.
                </p>
                ...
                <div className="grid grid-cols-2 gap-4 md:gap-6">
                  <div className="glass rounded-2xl p-4 md:p-6">
                    ...
                    <p className="text-lg md:text-xl font-black">2-3 часа</p>
                  </div>
                  <div className="glass rounded-2xl p-4 md:p-6">
                    ...
                    <p className="text-lg md:text-xl font-black">7-14 дней</p>
                  </div>
                  <div className="glass rounded-2xl p-4 md:p-6">
              ...
              <div className="relative">
                <div className="glass rounded-2xl md:rounded-3xl p-6 md:p-8 space-y-4">
                  ...
                  {[
                    { icon: "chat", text: "Консультация и подбор формы" },
                    { icon: "draw", text: "Создание эскиза и согласование" },
        ...
        <section className="mb-24 md:mb-28 lg:mb-32 max-[480px]:mb-20 max-[320px]:mb-16">
          <div className="relative rounded-2xl md:rounded-[3rem] overflow-hidden bg-gradient-to-br from-slate-50 to-slate-100 p-8 md:p-12 lg:p-16 max-[480px]:p-6">
            ...
            <div className="relative text-center mb-12 md:mb-16 space-y-3 md:space-y-4">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-black">Этапы создания идеальных бровей</h2>
              ...
              {[
                {
                  step: "01",
                  title: "Консультация",
                  description: "Обсуждаем желаемый результат, подбираем форму и цвет, учитываем особенности лица",
                  icon: "chat",
                  duration: "15-20 мин"
                },
                {
                  ...
                  description: "Рисуем эскиз бровей, корректируем форму до идеального результата",
                  icon: "draw",
                  duration: "20-30 мин"
                },
                {
                  step: "03",
                  title: "Анестезия",
                  description: "Наносим обезболивающий крем для максимального комфорта во время процедуры",
                  icon: "healing",
                  duration: "15-20 мин"
                },
                {
                  ...
                  description: "Создаем перманентный макияж выбранной техникой с соблюдением всех норм стерильности",
                  icon: "brush",
        ...
        <section id="portfolio" className="mb-24 md:mb-28 lg:mb-32 max-[480px]:mb-20 max-[320px]:mb-16">
          <div className="text-center mb-12 md:mb-16 space-y-3 md:space-y-4">
            ...
            <p className="text-slate-500 max-w-2xl mx-auto text-base md:text-lg px-4">Примеры наших работ по перманентному макияжу бровей</p>
          </div>
        ...
        <section className="mb-24 md:mb-28 lg:mb-32 max-[480px]:mb-20 max-[320px]:mb-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-12 items-center">
            ...
            <div className="space-y-6 md:space-y-8 order-1 lg:order-2">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-black">Почему выбирают нас для перманента бровей</h2>
              <p className="text-lg md:text-xl text-slate-600 leading-relaxed">
                Мы создаем не просто красивые брови, а индивидуальную архитектуру лица, которая подчеркивает вашу естественную красоту.
              </p>
              <div className="space-y-5 md:space-y-6">
                <div className="flex gap-4 md:gap-6 items-start group">
                  ...
                  <div>
                    ...
                    <p className="text-sm md:text-base text-slate-600">Используем только премиальные пигменты европейского производства, безопасные для кожи</p>
                  </div>
                </div>
                <div className="flex gap-4 md:gap-6 items-start group">
                  <div className="size-12 md:size-14 rounded-xl md:rounded-2xl bg-gradient-to-br from-accent-purple to-primary flex items-center justify-center text-white shadow-lg flex-shrink-0 group-hover:scale-110 transition-transform">
                    <span className="material-symbols-outlined text-xl md:text-2xl">face_3</span>
                  </div>
                  <div>
                    <h3 className="font-black text-base md:text-lg mb-1 md:mb-2">Индивидуальный подход</h3>
                    <p className="text-sm md:text-base text-slate-600">Подбираем форму и цвет с учетом типа лица, цветотипа и личных пожеланий</p>
                  </div>
                </div>
                <div className="flex gap-4 md:gap-6 items-start group">
        ...
        <section className="mb-24 md:mb-28 lg:mb-32 max-[480px]:mb-20 max-[320px]:mb-16">
          <div className="text-center mb-12 md:mb-16 space-y-3 md:space-y-4">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black">Частые вопросы о перманенте бровей</h2>
            ...
            <div className="relative z-10 max-w-3xl mx-auto space-y-6 md:space-y-8">
              ...
              <div className="flex items-center justify-center gap-8 pt-6 text-white/80">
                <div className="text-center">
                  <p className="text-2xl font-black text-white">от 4000₽</p>
                  <p className="text-sm">Стоимость процедуры</p>
                </div>
                <div className="text-center">
                  <p className="text-2xl font-black text-white">4-6 недель</p>
                  <p className="text-sm">До коррекции</p>
                </div>
                <div className="text-center">

...
export default function PermanentLipsPage() {
  ...
  const faqItems = [
    {
      question: "Больно ли делать перманентный макияж губ?",
      answer: "Губы — чувствительная зона, но мы используем качественную анестезию. Процедура проходит комфортно, клиенты отмечают терпимые ощущения.",
      icon: "healing"
    },
    {
      question: "Сколько держится перманентный макияж губ?",
      answer: "В зависимости от индивидуальных особенностей кожи и образа жизни — от 1 до 2 лет. Яркие оттенки выцветают быстрее натуральных.",
      icon: "schedule"
    },
    {
      question: "Нужна ли коррекция после процедуры?",
      answer: "Да, коррекция проводится через 4-6 недель после первой процедуры. Она необходима для закрепления цвета и идеального результата.",
      icon: "tune"
    },
    {
      ...
      <main className="max-w-7xl mx-auto px-6 md:px-8 lg:px-6 max-[480px]:px-4 max-[320px]:px-3 py-12 md:py-16 max-[480px]:py-8 max-[320px]:py-6 max-[767px]:pb-32 overflow-hidden">
          ...
          <div className="relative rounded-2xl md:rounded-[3rem] overflow-hidden bg-gradient-to-br from-slate-50 to-slate-100 p-8 md:p-12 lg:p-16 max-[480px]:p-6">
            ...
            <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-12 items-center">
              <div className="space-y-6 md:space-y-8">
                ...
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-black">Акварельные губы</h2>
              ...
              <div className="relative">
                <div className="glass rounded-2xl md:rounded-3xl p-6 md:p-8 space-y-4">
                  ...
                  {[
                    { icon: "chat", text: "Консультация и подбор оттенка" },
        ...
        <section className="mb-24 md:mb-28 lg:mb-32 max-[480px]:mb-20 max-[320px]:mb-16">
          <div className="relative rounded-2xl md:rounded-[3rem] overflow-hidden bg-gradient-to-br from-slate-50 to-slate-100 p-8 md:p-12 lg:p-16 max-[480px]:p-6">
            ...
            <div className="relative text-center mb-12 md:mb-16 space-y-3 md:space-y-4">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-black">Этапы создания идеальных губ</h2>
              ...
              {[
                {
                  step: "01",
                  title: "Консультация",
                  description: "Обсуждаем желаемый результат, подбираем оттенок и форму губ",
                  icon: "chat",
                  duration: "15-20 мин"
                },
                {
        ...
        <section id="portfolio" className="mb-24 md:mb-28 lg:mb-32 max-[480px]:mb-20 max-[320px]:mb-16">
          <div className="text-center mb-12 md:mb-16 space-y-3 md:space-y-4">
            ...
            <p className="text-slate-500 max-w-2xl mx-auto text-base md:text-lg px-4">Примеры наших работ по перманентному макияжу губ</p>
          </div>
        ...
        <section className="mb-24 md:mb-28 lg:mb-32 max-[480px]:mb-20 max-[320px]:mb-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-12 items-center">
            ...
            <div className="space-y-6 md:space-y-8 order-1 lg:order-2">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-black">Почему выбирают нас для перманента губ</h2>
              <p className="text-lg md:text-xl text-slate-600 leading-relaxed">
                Мы создаем естественную красоту губ, которая подчеркивает вашу индивидуальность и сохраняется на годы.
              </p>
              <div className="space-y-5 md:space-y-6">
                <div className="flex gap-4 md:gap-6 items-start group">
                  ...
                  <div>
                    ...
                    <p className="text-sm md:text-base text-slate-600">Используем только премиальные пигменты европейского производства, безопасные для губ</p>
                  </div>
                </div>
                <div className="flex gap-4 md:gap-6 items-start group">
                  ...
                  <div>
                    ...
                    <p className="text-sm md:text-base text-slate-600">Подбираем оттенок с учетом цветотипа, формы губ и личных пожеланий</p>
                  </div>
                </div>
                <div className="flex gap-4 md:gap-6 items-start group">
        ...
        <section className="mb-24 md:mb-28 lg:mb-32 max-[480px]:mb-20 max-[320px]:mb-16">
          <div className="text-center mb-12 md:mb-16 space-y-3 md:space-y-4">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black">Частые вопросы о перманенте губ</h2>

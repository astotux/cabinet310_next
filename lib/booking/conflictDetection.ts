 ...
 * - Маникюр (Мастер А) и Перманент (Мастер Б) используют общую зону и конфликтуют
 * - Маникюр (Мастер А) и Ламинирование (Мастер Б) используют разные зоны и НЕ конфликтуют
 * 
 ...
 *    - Маникюр (Мастер А) + Перманент (Мастер Б) = КОНФЛИКТ (общая зона)
 *    - Маникюр (Мастер А) + Ламинирование (Мастер Б) = НЕТ КОНФЛИКТА (разные зоны)
 ...
 * hasConflict(
 *   { service: 'Маникюр', master: 'Мастер А', startTime: ..., endTime: ... },
 *   { service: 'Наращивание', master: 'Мастер А', startTime: ..., endTime: ... }
 * ) // true
 * 
 * @example
 ...
 * hasConflict(
 *   { service: 'Маникюр', master: 'Мастер А', startTime: ..., endTime: ... },
 *   { service: 'Перманент', master: 'Мастер Б', startTime: ..., endTime: ... }
 * ) // true
 * 
 * @example
 ...
 * hasConflict(
 *   { service: 'Маникюр', master: 'Мастер А', startTime: ..., endTime: ... },
 *   { service: 'Ламинирование', master: 'Мастер Б', startTime: ..., endTime: ... }
 * ) // false
 */
